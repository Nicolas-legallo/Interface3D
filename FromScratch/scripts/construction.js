...
function CreationPage(){
  ...
  if(modeConstruction == true && modeVisu == false){
    ...
    "<button type='button' class='btn btn-secondary' id='createStream'><img src='/usine3D/FromScratch/img/logo/Ajouter24x24.png'>Flux</button>"+
