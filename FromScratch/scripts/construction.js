...
function CreationPage(){
  ...
  if(modeConstruction == true && modeVisu == false){
    ...
    contenu +=   "<div id='buttons' class='HolyGrail-nav'><div id='toggler'>Importer un objet <img id='flechebibli' class='toggleup' src='/usine3D/FromScratch/img/logo/bas16x16.png'></div><div id='biblio'>  <div class='tab'><button class='tablinks selectedcontent' id='tab1'>Transfo</button><button class='tablinks' id='tab2'>Stockage</button><button class='tablinks' id='tab3'>Autre</button></div>"+
          " <div id='content1' class='tabcontent'><figure><img src='./plan.png' id='clickbox' alt='Cube.png' height='64' width='64'><figcaption> Cube </figcaption></figure><figure><img src='./plan.png' id='clickligneprod' alt='ligneprod.png' height='64' width='64'><figcaption> Ligne Prod</figcaption></figure>"+
          "<figure><img src='./plan.png' id='clickchariot' alt='chariot.png' height='64' width='64'><figcaption> Chariot</figcaption></figure><figure><img src='./plan.png' id='clickstock1' alt='stock1.png' height='64' width='64'><figcaption>Stock 1</figcaption></figure></div>"+
          "<div id='content2' class='tabcontent'><figure><img src='./plan.png' id='clickstock2' alt='stock2.png' height='64' width='64'><figcaption>Stock 2</figcaption></figure><figure><img src='./plan.png' id='clickstock3' alt='stock3.png' height='64' width='64'><figcaption>Stock 3</figcaption></figure>"+
          "<figure><img src='./plan.png' id='clickcamera' alt='camera.png' height='64' width='64'><figcaption>Camera</figcaption></figure><figure><img src='./plan.png' id='clickcopilote' alt='postecopilote.png' height='64' width='64'><figcaption>Poste</figcaption></figure></div>"+
          "<div id='content3' class='tabcontent'><figure><img src='./plan.png' id='clickrail' alt='rail.png' height='64' width='64'><figcaption>Rail</figcaption></figure><figure><img src='./plan.png' alt='Smiley face' height='64' width='64'><figcaption> 404 </figcaption></figure>"+
