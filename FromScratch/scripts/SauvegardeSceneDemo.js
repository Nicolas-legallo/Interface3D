/***************************************
  ...
  SAUVEGARDE DU Script principal de démonstration, majoritairement composé de fonctions BabylonJS.
  Permet la création de la scène 3D et la gestion de tout ce qu'il s'y passe.

DATE : 16/05
Bugs connus :  - pb de sélection du sol à cause de la skybox
               - pb de décalage souris/scene
...
var cubeligneprod8;
  ...
  // permet de garantir l'ordre de chargement des objets et donc de régulariser l'apparition des flux
    ...
    var ligneprod1 = BABYLON.SceneLoader.ImportMesh("", "/usine3d/FromScratch/objets/scenes/obj/", "ligneProd.obj", scene, function(newMeshes) { //import de l'objt 3D .babylon , appel de fonction callBack OnSuccess
...
var stockage21  = BABYLON.SceneLoader.ImportMesh("", "/usine3d/FromScratch/objlouis/", "stockage2.obj", scene, function(newMeshes){
  var mesh = newMeshes[0];
  mesh.scaling.x = 6;
  mesh.scaling.z = 6;
  mesh.scaling.y = 6;
...
var stockage31 = BABYLON.SceneLoader.ImportMesh("","/usine3d/FromScratch/objlouis/", "stockage2.obj", scene, function(newMeshes){
  var mesh = newMeshes[0];
  mesh.scaling.x = 5;
  mesh.scaling.y = 5;
  mesh.scaling.z = 5;
...
var stockage32 = BABYLON.SceneLoader.ImportMesh("","/usine3d/FromScratch/objlouis/", "stockage2.obj", scene, function(newMeshes){
  var mesh = newMeshes[0];
  mesh.scaling.x = 5;
  mesh.scaling.y = 5;
  mesh.scaling.z = 5;
...
var stockage33 = BABYLON.SceneLoader.ImportMesh("","/usine3d/FromScratch/objlouis/", "stockage2.obj", scene, function(newMeshes){
  var mesh = newMeshes[0];
  mesh.scaling.x = 5;
  mesh.scaling.y = 5;
  mesh.scaling.z = 5;
...
var stockage34 = BABYLON.SceneLoader.ImportMesh("","/usine3d/FromScratch/objlouis/", "stockage2.obj", scene, function(newMeshes){
  var mesh = newMeshes[0];
  mesh.scaling.x = 5;
  mesh.scaling.y = 5;
  mesh.scaling.z = 5;
...
var stockage36 = BABYLON.SceneLoader.ImportMesh("","/usine3d/FromScratch/objlouis/", "stockage2.obj", scene, function(newMeshes){
  var mesh = newMeshes[0];
  mesh.scaling.x = 5;
  mesh.scaling.y = 5;
  mesh.scaling.z = 5;
...
var stockage37 = BABYLON.SceneLoader.ImportMesh("","/usine3d/FromScratch/objlouis/", "stockage2.obj", scene, function(newMeshes){
  var mesh = newMeshes[0];
  mesh.scaling.x = 5;
  mesh.scaling.y = 5;
  mesh.scaling.z = 5;
...
var stockage38 = BABYLON.SceneLoader.ImportMesh("","/usine3d/FromScratch/objlouis/", "stockage2.obj", scene, function(newMeshes){
  var mesh = newMeshes[0];
  mesh.scaling.x = 5;
  mesh.scaling.y = 5;
  mesh.scaling.z = 5;
...
//createFlux(ligneprod1.position,cube4.position);
    ...
    $("#infos").click(function(evt) { //on écoute l'évènement de clic droit.
